...
for mass in masses:
 ...
 outfile="JJ_cards_8TeV/datacards/CMS_jj_Zprimefix_WW_ZH_"+str(mass)+"_8TeV_CMS_jj_VV.txt"
 print outfile
 f=open(outfile,"w")
 ...
 for l in range(len(fWW)):
  ...
  if "rate" in fWW[l]:
   ...
   for s in range(len(fWWsplit)):
    ...
    if signal:
     eff = numberWW*100.*0.6760/0.6991/19700.
     #print eff,eff*0.14*0.577*100/0.9/0.6760
     numberWW=numberWW*100.*HVTWW[mass]+eff*0.14*0.577*19700.*HVTZH[mass]/0.9/0.6760
