...
def plot_Asympt_limits(label,signalstrenght):
 ...
 for m in mass:
   if signalstrenght:
    ...
    scale['xww13'][m] = theMap13['WW'][idx]
    scale['xjj13'][m] = theMap13['WW'][idx]+theMap13['ZZ'][idx]
    if m < 3000:
     idx2 = theMap8['M'].index(m)
     scale['ALL8'][m] = theMap8['WW'][idx2]+theMap8['ZZ'][idx2]
     scale['ALL813'][m] = theMap13['WW'][idx]+theMap13['ZZ'][idx]+theMap8['WW'][idx2]+theMap8['ZZ'][idx2]
     scale['xww'][m] = theMap8['WW'][idx2]
     scale['xzz'][m] = theMap8['ZZ'][idx2]
     scale['xjj8'][m] = theMap8['WW'][idx2]+theMap8['ZZ'][idx2] 
    else:
     scale['ALL813'][m] = theMap13['WW'][idx]+theMap13['ZZ'][idx]
...
def compare_Asympt_limits(labels,unblind,bands):
 ...
 legs1={}
 legs1["ALL13"]=[0.45,0.34,0.90,0.45]
 legs1["ALL8"]=[0.47,0.31,0.90,0.42]
 legs1["ALL813"]=[0.45,0.34,0.90,0.45]
    
 legs2={}
 legs2["ALL13"]=[0.43,0.25,0.88,0.30]
 legs2["ALL8"]=[0.44,0.17,0.88,0.27]
 legs2["ALL813"]=[0.3087248,0.179402,0.8791946,0.3289037]

 legs3={}
 legs3["ALL13"]=[0.17,0.78,0.43,0.88]
 legs3["ALL8"]=[0.17,0.75,0.43,0.88]
 legs3["ALL813"]=[0.17,0.66,0.43,0.90]
 ...
 leg = ROOT.TLegend(0.3808725,0.192691,0.8959732,0.3853821)
 ...
 hrl_SM = canv.DrawFrame(0.75,0.5, x+0.050, 50000) 
...
if __name__ == '__main__':
 ...
 # 8+13 TeV BulkG
 scenarios["ALL813TeV"]=["ALL813","xww","xzz","xjj8","xww13","xjj13"]
