...
for mass in masses:
	  ...
	  #fWW=open("WW_cards_13TeV_noMassCategory/wwlvj_BulkG_WW_lvjj_M"+str(mass)+"_noMassCat_combo_ALLP_unbin.txt").readlines()
	  #fWW=open("WW_cards_13TeV_oldSys/wwlvj_BulkG_WW_lvjj_M"+str(mass)+"_combo_ALLP_unbin.txt").readlines()
	except:
	  print "could not open"
	  continue
	outfile="WW_cards_13TeV/wwlvj_BulkGfix_WW_lvjj_M"+str(mass)+"_combo_ALLP_unbin.txt"
	#outfile="WW_cards_13TeV_noMassCategory/wwlvj_BulkGfix_WW_lvjj_M"+str(mass)+"_noMassCat_combo_ALLP_unbin.txt"
	#outfile="WW_cards_13TeV_oldSys/wwlvj_BulkGfix_WW_lvjj_M"+str(mass)+"_oldSys_combo_ALLP_unbin.txt"
	print outfile
        f=open(outfile,"w")
