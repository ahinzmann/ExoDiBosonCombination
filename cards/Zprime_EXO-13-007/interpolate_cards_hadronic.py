...
for mass in input_masses:
    for line in open("cards_hadronic/counting_BoostedTausFullyHadronic_M"+str(mass)+"_card.txt").readlines():
        if "rate " in line:
...
for mass in masses:
        print "mass = ",mass
	fin=open("cards_hadronic/counting_BoostedTausFullyHadronic_M1000_card.txt").readlines()
	outfile="cards_hadronic/counting_BoostedTausFullyHadronic_M"+str(mass)+"_card_interpolate.txt"
	print outfile
        f=open(outfile,"w")
