...
HVTBRZH={}
HVTBRZW={}
for line in open("HVTcrossSection_13TeV.txt").readlines()[1:]:
   split=line.replace("\n","").split(",")
...
f_out_VH=open("theory_HVT_VH_13TeV.txt","w")
for mass in masses:
...
f_out_WH=open("theory_HVT_WH_13TeV.txt","w")
for mass in masses:
...
f_out_ZH=open("theory_HVT_ZH_13TeV.txt","w")
for mass in masses:
...
f_out_VW=open("theory_HVT_VW_13TeV.txt","w")
for mass in masses:
...
f_out_WZ=open("theory_HVT_WZ_13TeV.txt","w")
for mass in masses:
...
f_out_WW=open("theory_HVT_WW_13TeV.txt","w")
for mass in masses:
...
f_out_HVT=open("theory_HVT_13TeV.txt","w")
for mass in masses:
...
f_out_HVT=open("theory_Wprime_13TeV.txt","w")
for mass in masses:
        #theoryHVT=exp(g_HVT.Eval(mass))/1000.
        theoryHVT=HVTWprime[mass]
	f_out_HVT.write(str(mass)+" "+str(theoryHVT)+"\n")
        print "mass = ",mass,"theoryHVT = ",theoryHVT
f_out_HVT.close()
