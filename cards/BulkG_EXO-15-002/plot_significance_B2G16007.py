...
def plot_significance(label):
 ...
 infileObs = "BulkGResults/higgsCombine%sObsSignif.ProfileLikelihood.TOTAL.root"%label
 infileExp = "BulkGResults/higgsCombine%sExpSignif.ProfileLikelihood.TOTAL.root"%label
...
def compare_significance(labels):
 ...
 legs1={}
 legs1["ALL13"]=[0.48,0.32,0.90,0.41]
 legs1["ALL8"]=[0.48,0.28,0.90,0.41]
 legs1["ALL813"]=[0.48,0.32,0.90,0.41]
    
 legs2={}
 legs2["ALL13"]=[0.41,0.26,0.88,0.31]
 legs2["ALL8"]=[0.41,0.19,0.84,0.27]
 legs2["ALL813"]=[0.34,0.18,0.85,0.31]
