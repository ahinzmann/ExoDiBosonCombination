...
void plot_golfcourse_Asymptotic_signalstrength(bool unblind = true, char* width = 0, char* scenario = "ALL");
void setFPStyle();
...
void plot_golfcourse_Asymptotic_signalstrength(bool unblind, char* width, char* scenario)
{
...
//   }
  ...
  */
  ...
  char fnam[50];
  if (width != 0) {
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s.root", scenario, width);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s.eps", scenario, width);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s.png", scenario, width);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s.pdf", scenario, width);
    cMCMC->SaveAs(fnam);
    gPad->SetLogy();
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s_log.eps", scenario, width);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s_log.png", scenario, width);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_%s_log.pdf", scenario, width);
    cMCMC->SaveAs(fnam);
  } else {
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic.root", scenario);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic.eps", scenario);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic.png", scenario);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic.pdf", scenario);
    cMCMC->SaveAs(fnam);
    gPad->SetLogy();
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_log.eps", scenario);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_log.png", scenario);
    cMCMC->SaveAs(fnam);
    sprintf(fnam, "EXOVH_%s_UL_Asymptotic_log.pdf", scenario);
    cMCMC->SaveAs(fnam);
  }
