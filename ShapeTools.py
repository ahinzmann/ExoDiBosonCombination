...
class ShapeBuilder(ModelBuilder):
    ...
    def getShape(self,channel,process,syst="",_fileCache={},_cache={},allowNoSyst=False):
        ...
        else: return None #raise KeyError, "Shape map has no entry for channel '%s'" % (channel)
        names = []
        ...
        else: return None #raise KeyError, "Shape map has no entry for process '%s', channel '%s'" % (process,channel)
