string="signal & mass & JJ (8 TeV) & lvJ (8 TeV) & llJ (8 TeV) & JJ (13 TeV) & lvJ (13 TeV) & llJ (13 TeV) & qqbb (8 TeV) & lvbb (8 TeV) & qqtautau (8 TeV) & llbb (13 TeV) & lvbb (13 TeV) & vvbb (13 TeV) \\\\\n"

masses = [2000]
for mass in masses:
  xsec=open("../Wprime_EXO-15-002/theory_HVT_WZ_8TeV.txt")
  ...
  if mass<2500:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_lljwz8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass>=1200:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_jjwzwh13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[7])+float(split[4]))/crosssection13/2600.,(float(split[13])+float(split[10])+float(split[16]))/crosssection13/2600.)]
  else:
    yields+=[(0,0)]

  if mass>=1200:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_lvjwzh13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass>=1000 and mass<2500:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_jjwh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass<2500:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_lvjwh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[6]))/crosssection8/19700.,0)]
  ...
  if mass<2500:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_ttjwh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass>=1200:
   card=open("../Wprime_B2G-16-007/comb_"+str(mass)+"/comb_lvjwh13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[5])+float(split[9])+float(split[13]))/crosssection13/2300.,0)]
  else:
    yields+=[(0,0)]
...
for mass in masses:
  xsec=open("../Wprime_EXO-15-002/theory_HVT_WW_8TeV.txt")
  for l in xsec.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]==str(mass):
      crosssection8=float(split[1])
  ...
  yields=[]
  if mass>=1000 and mass<2500:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_jjwwzh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[2]))/crosssection8/19700.,(float(split[6]))/crosssection8/19700.)]
  ...
  if mass<2500:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_lvjww8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[6]))/crosssection8/19700.,0)]
  ...
  if mass>=1200:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_jjwwzh13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass>=1200:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_lvjww13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[6])+float(split[21])+float(split[26]))/crosssection13/2300.,(float(split[11])+float(split[16])+float(split[31])+float(split[36]))/crosssection13/2300.)]
  ...
  xsec=open("../Wprime_EXO-15-002/theory_HVT_ZH_13TeV.txt")
  for l in xsec.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]==str(mass):
      crosssection13=float(split[1])
  ...
  if mass>=1000 and mass<2500:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_jjzh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
  ...
  if mass<2500:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_ttjzh8."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[3])+float(split[5])+float(split[7])+float(split[9])+float(split[11]))/crosssection8/19700.,0)]
  ...
  if mass>=1200:
   card=open("../Zprime_B2G-16-007/comb_"+str(mass)+"/comb_lljnnjzh13."+str(mass)+".txt")
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[9])+float(split[13])+float(split[17])+float(split[21]))/crosssection13/2300.,0)]
  else:
    yields+=[(0,0)]
  ...
  if mass>=1200:
   ...
   for l in card.readlines():
    split=l.replace("\n"," ").replace("\t"," ").replace("     "," ").replace("    "," ").replace("   "," ").replace("  "," ").split(" ")
    if split[0]=="rate":
      yields+=[((float(split[1])+float(split[5]))/crosssection13/2300.,0)]
  else:
    yields+=[(0,0)]
