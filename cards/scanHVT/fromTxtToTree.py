...
outfile = TFile.Open('scanHVT-M3000.root','RECREATE')
outtree = TTree("hvtM3000","hvtM3000")
...
infile13 = open('data/scanHVT-M3000.txt','r')
lines = infile13.readlines()

infile8 = open('data/scanHVT-M3000_8TeV.txt','r')    
nlines = -1
for line in infile8:
