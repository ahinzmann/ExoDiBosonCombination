...
def compare_Asympt_limits(labels):
 ...
 #line color
 lcol = {}
 lcol["ALL13"] = col.GetColor(palette[9])
 lcol["ALL8"] = col.GetColor(palette[2])
 lcol["ALL813"] = col.GetColor(palette[5])
 #marker color
 mcol = {}
 mcol["ALL13"] = col.GetColor(palette[9])
 mcol["ALL8"] = col.GetColor(palette[2])
 mcol["ALL813"] = col.GetColor(palette[5])
 #marker style
 msty = {}
 msty["ALL13"] = 26
 msty["ALL8"] = 31
 ...
 names = {}
 names["ALL13"]="13 TeV VV channels"#"lvJ, JJ (13 TeV)"
 names["ALL8"]="8 TeV VV channels"#"lvJ, llJ, JJ (8 TeV)"
 names["ALL813"]="8+13 TeV combination"#"lvJ, llJ, JJ (8+13 TeV)"
 ...
 leg2 = ROOT.TLegend(0.37,0.19,0.88,0.33)
 leg2.SetBorderSize(0)
 ...
 npoints = graphobs[2].GetN()
 x = ROOT.Double(0.)
 y = ROOT.Double(0.)
 graphobs[2].GetPoint(npoints-1,x,y)

 hrl_SM = canv.DrawFrame(0.75,0.5, x+0.050, 100000) 
 ...
 graphth[2].SetLineStyle(3)
 graphth[2].Draw("L")
 theoleg = "G_{bulk} , #tilde{k}=0.5"
 leg.AddEntry(graphth[2],theoleg,"L")
 ...
 canv.SaveAs("plots/EXOVVbulkg_compare_ALL_"+suffix+".root")
 canv.SaveAs("plots/EXOVVbulkg_compare_ALL_"+suffix+".png")
 canv.SaveAs("plots/EXOVVbulkg_compare_ALL_"+suffix+".pdf")
 canv.SaveAs("plots/EXOVVbulkg_compare_ALL_"+suffix+".eps")
...
if __name__ == '__main__':
 ...
 # comapre all combinations
 scenarios["ALL"]=["ALL8","ALL13","ALL813"]
