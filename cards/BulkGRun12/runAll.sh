...
for M in $( cat masses813.txt ); do ./parallelizeCombine.sh $M ALL13; done &
for M in $( cat masses813.txt ); do ./parallelizeCombine.sh $M ALL813; done
...
for M in $( cat masses813.txt ); do ./mergeCombinationTrees.sh $M ALL13; done &
for M in $( cat masses813.txt ); do ./mergeCombinationTrees.sh $M ALL813; done
