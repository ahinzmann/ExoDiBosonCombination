...
def compare_Asympt_limits(labels):
 ...
 lcol['ALLWPRIME13'] = col.GetColor(palette[9])
 ...
 mcol['ALLWPRIME13'] = col.GetColor(palette[9])
 ...
 names = {}
 names['ALLWPRIME138'] = "8+13 TeV combination"
 names["JJLVJWPRIME13"]="13 TeV VV channels"
 names["ALLWPRIME13"]="13 TeV VV channels"
 names['ALLWPRIME8'] = "8 TeV VV+VH channels"
 ...
 leg2 = ROOT.TLegend(0.37,0.16,0.88,0.33)
 leg2.SetBorderSize(0)
 ...
 canv.SaveAs("plots/EXOVVhvt_compare_ALLWPRIME_"+suffix+".root")
 canv.SaveAs("plots/EXOVVhvt_compare_ALLWPRIME_"+suffix+".png")
 canv.SaveAs("plots/EXOVVhvt_compare_ALLWPRIME_"+suffix+".pdf")
 canv.SaveAs("plots/EXOVVhvt_compare_ALLWPRIME_"+suffix+".eps")
...
if __name__ == '__main__':
 ...
 scenarios["ALLWPRIME"]=["ALLWPRIME8","ALLWPRIME13","ALLWPRIME138"]
