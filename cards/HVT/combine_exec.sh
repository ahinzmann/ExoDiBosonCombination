...
if [ $ONED -eq 0 ]
    then
    WORKDIR=/afs/cern.ch/user/h/hinzmann/workspace/limit_combination/CMSSW_7_1_5/src/ExoDiBosonCombination/cards/HVT/${OUTDIR}/comb_${mass}_${width}
fi
...
#change range of scan specifically for HVT->VH
if [ $mass -gt 2000 ]
    then
    maxBoundary=1000
    minBoundary=0.1
