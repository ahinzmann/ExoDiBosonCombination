...
for mass in masses:
 ...
 outfile="LVJ_cards_13TeV/wwlvj_Vprimefix_WV_lvjj_M"+str(mass)+"_combo_ALLP_unbin.txt"
 print outfile
 f=open(outfile,"w")
 ...
 for l in range(len(fWZ)):
  if "rate" in fWZ[l]:
   ...
   for s in range(len(fWZsplit)):
    ...
    if signal: yieldsWprime.append(numberWZ*WprimeWZ[mass]*100.) # cards from Jennnifer are in units of 0.01 pb   
