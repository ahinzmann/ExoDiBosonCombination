...
for mass in masses:
 ...
 outfile="JJ_cards_8TeV/datacards/CMS_jj_Vprimefix_WV_VH_"+str(mass)+"_8TeV_CMS_jj_VV.txt"
 print outfile
 f=open(outfile,"w")
 ...
 HVTWH[mass]=xsecMap['CX0(pb)'][m]*xsecMap['BRWh'][m]
 HVTWW[mass]=xsecMap['CX0(pb)'][m]*xsecMap['BRWW'][m]*0.6760/0.6991
 HVTZH[mass]=xsecMap['CX0(pb)'][m]*xsecMap['BRhZ'][m]
 ...
 for l in range(len(fWW)):
  ...
  if "rate" in fWW[l]:
   ...
   for s in range(len(fWWsplit)):
    ...
    if signal:
     effWW = numberWW*100.*0.6760/0.6991/19700.
     effWZ = numberWW*100./19700.
     numberWW=numberWW*100.*HVTWZ[mass]+numberWW*100.*HVTWW[mass]+effWW*0.14*0.577*19700.*HVTZH[mass]/0.9/0.6760+effWZ*0.14*0.577*19700.*HVTWH[mass]/0.9/0.6991
