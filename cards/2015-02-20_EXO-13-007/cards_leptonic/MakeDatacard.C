void MakeDatacard(){
  ...
  for(int i=0; i<7; i++){
    if(i==0) SignalMass=800;
    if(i==1) SignalMass=900;
    if(i==2) SignalMass=1000;
    if(i==3) SignalMass=1200;
    if(i==4) SignalMass=1500;
    if(i==5) SignalMass=2000;
    if(i==6) SignalMass=2500;
    if(SignalMass==800){
      WIDTH=125;
      MIN=675;
      MAX=800;
...
void BackgroundEstimation(char *channel, float XMassWidth, float XMassBin, float XMassMin, float XMassMax, TH1F *histo_PRE, TH1F *histo_DAT, TH1F *ERR, 
  ...
  if(SignalMass==800)      { const int N = 14; Double_t xbins[N] = {0,300,550,675,800,925,1150,1300,1500,1700,1900,2200,2500,3000}; }
  else if(SignalMass==900) { const int N = 13; Double_t xbins[N] = {0,300,500,750,900,1050,1250,1500,1750,2000,2250,2500,3000};     }
  else if(SignalMass==1000){ const int N = 14; Double_t xbins[N] = {0,300,550,700,850,1000,1150,1300,1500,1700,1900,2200,2500,3000};}
  else if(SignalMass==1200){ const int N = 13; Double_t xbins[N] = {0,300,500,750,1000,1200,1400,1600,1800,2000,2250,2500,3000};    }
  else if(SignalMass==1500){ const int N = 12; Double_t xbins[N] = {0,300,500,750,1000,1250,1500,1750,2000,2250,2500,3200};         }
  else if(SignalMass==2000){ const int N = 14; Double_t xbins[N] = {0,300,550,700,850,1000,1150,1300,1500,1700,2000,2300,2500,3000};}
  else if(SignalMass==2500){ const int N = 13; Double_t xbins[N] = {0,300,550,700,850,1000,1150,1300,1550,1800,2050,2500,2950};     }
  ...
  for(int i=0; i<N-1; i++){
    ...
    if(SignalMass== 800 && ((xbins[AAA1]== 675 && xbins[AAA2]== 800) || (xbins[AAA1]==800  && xbins[AAA2]== 925))) Nsideband=Nsideband+N_sb;
    if(SignalMass== 900 && ((xbins[AAA1]== 750 && xbins[AAA2]== 900) || (xbins[AAA1]==900  && xbins[AAA2]==1050))) Nsideband=Nsideband+N_sb;
    if(SignalMass==1000 && ((xbins[AAA1]== 850 && xbins[AAA2]==1000) || (xbins[AAA1]==1000 && xbins[AAA2]==1150))) Nsideband=Nsideband+N_sb;
    if(SignalMass==1200 && ((xbins[AAA1]==1000 && xbins[AAA2]==1200) || (xbins[AAA1]==1200 && xbins[AAA2]==1400))) Nsideband=Nsideband+N_sb;
    if(SignalMass==1500 && ((xbins[AAA1]==1250 && xbins[AAA2]==1500) || (xbins[AAA1]==1500 && xbins[AAA2]==1750))) Nsideband=Nsideband+N_sb;
    if(SignalMass==2000 && ((xbins[AAA1]==1700 && xbins[AAA2]==2000) || (xbins[AAA1]==2000 && xbins[AAA2]==2300))) Nsideband=Nsideband+N_sb;
    if(SignalMass==2500 && ((xbins[AAA1]==2050 && xbins[AAA2]==2500) || (xbins[AAA1]==2500 && xbins[AAA2]==2950))) Nsideband=Nsideband+N_sb;
    if(SignalMass== 800 && ((xbins[AAA1]== 675 && xbins[AAA2]== 800) || (xbins[AAA1]== 800 && xbins[AAA2]== 925))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass== 900 && ((xbins[AAA1]== 750 && xbins[AAA2]== 900) || (xbins[AAA1]== 900 && xbins[AAA2]==1050))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass==1000 && ((xbins[AAA1]== 850 && xbins[AAA2]==1000) || (xbins[AAA1]==1000 && xbins[AAA2]==1150))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass==1200 && ((xbins[AAA1]==1000 && xbins[AAA2]==1200) || (xbins[AAA1]==1200 && xbins[AAA2]==1400))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass==1500 && ((xbins[AAA1]==1250 && xbins[AAA2]==1500) || (xbins[AAA1]==1500 && xbins[AAA2]==1750))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass==2000 && ((xbins[AAA1]==1700 && xbins[AAA2]==2000) || (xbins[AAA1]==2000 && xbins[AAA2]==2300))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass==2500 && ((xbins[AAA1]==2050 && xbins[AAA2]==2500) || (xbins[AAA1]==2500 && xbins[AAA2]==2950))) DATYield=DATYield+data_SR->Integral();
    if(SignalMass== 800 && ((xbins[AAA1]== 675 && xbins[AAA2]== 800) || (xbins[AAA1]== 800 && xbins[AAA2]== 925))) BkgYield=BkgYield+N_PRE;
    if(SignalMass== 900 && ((xbins[AAA1]== 750 && xbins[AAA2]== 900) || (xbins[AAA1]== 900 && xbins[AAA2]==1050))) BkgYield=BkgYield+N_PRE;
    if(SignalMass==1000 && ((xbins[AAA1]== 850 && xbins[AAA2]==1000) || (xbins[AAA1]==1000 && xbins[AAA2]==1150))) BkgYield=BkgYield+N_PRE;
    if(SignalMass==1200 && ((xbins[AAA1]==1000 && xbins[AAA2]==1200) || (xbins[AAA1]==1200 && xbins[AAA2]==1400))) BkgYield=BkgYield+N_PRE;
    if(SignalMass==1500 && ((xbins[AAA1]==1250 && xbins[AAA2]==1500) || (xbins[AAA1]==1500 && xbins[AAA2]==1750))) BkgYield=BkgYield+N_PRE;
    if(SignalMass==2000 && ((xbins[AAA1]==1700 && xbins[AAA2]==2000) || (xbins[AAA1]==2000 && xbins[AAA2]==2300))) BkgYield=BkgYield+N_PRE;
    if(SignalMass==2500 && ((xbins[AAA1]==2050 && xbins[AAA2]==2500) || (xbins[AAA1]==2500 && xbins[AAA2]==2950))) BkgYield=BkgYield+N_PRE;
    if(SignalMass== 800 && ((xbins[AAA1]== 675 && xbins[AAA2]== 800) || (xbins[AAA1]== 800 && xbins[AAA2]== 925))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass== 900 && ((xbins[AAA1]== 750 && xbins[AAA2]== 900) || (xbins[AAA1]== 900 && xbins[AAA2]==1050))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass==1000 && ((xbins[AAA1]== 850 && xbins[AAA2]==1000) || (xbins[AAA1]==1000 && xbins[AAA2]==1150))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass==1200 && ((xbins[AAA1]==1000 && xbins[AAA2]==1200) || (xbins[AAA1]==1200 && xbins[AAA2]==1400))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass==1500 && ((xbins[AAA1]==1250 && xbins[AAA2]==1500) || (xbins[AAA1]==1500 && xbins[AAA2]==1750))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass==2000 && ((xbins[AAA1]==1700 && xbins[AAA2]==2000) || (xbins[AAA1]==2000 && xbins[AAA2]==2300))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass==2500 && ((xbins[AAA1]==2050 && xbins[AAA2]==2500) || (xbins[AAA1]==2500 && xbins[AAA2]==2950))) BkgYieldErr=BkgYieldErr*BkgYieldErr+N_PRE_err*N_PRE_err;
    if(SignalMass== 800 && (xbins[AAA1]== 675 && xbins[AAA2]== 800)) Alpha1=alpha;
    if(SignalMass== 900 && (xbins[AAA1]== 750 && xbins[AAA2]== 900)) Alpha1=alpha;
    if(SignalMass==1000 && (xbins[AAA1]== 850 && xbins[AAA2]==1000)) Alpha1=alpha;
    if(SignalMass==1200 && (xbins[AAA1]==1000 && xbins[AAA2]==1200)) Alpha1=alpha;
    if(SignalMass==1500 && (xbins[AAA1]==1250 && xbins[AAA2]==1500)) Alpha1=alpha;
    if(SignalMass==2000 && (xbins[AAA1]==1700 && xbins[AAA2]==2000)) Alpha1=alpha;
    if(SignalMass==2500 && (xbins[AAA1]==2050 && xbins[AAA2]==2500)) Alpha1=alpha;
    if(SignalMass== 800 && (xbins[AAA1]== 800 && xbins[AAA2]== 925)) Alpha2=alpha;
    if(SignalMass== 900 && (xbins[AAA1]== 900 && xbins[AAA2]==1050)) Alpha2=alpha;
    if(SignalMass==1000 && (xbins[AAA1]==1000 && xbins[AAA2]==1150)) Alpha2=alpha;
    if(SignalMass==1200 && (xbins[AAA1]==1200 && xbins[AAA2]==1400)) Alpha2=alpha;
    if(SignalMass==1500 && (xbins[AAA1]==1500 && xbins[AAA2]==1750)) Alpha2=alpha;
    if(SignalMass==2000 && (xbins[AAA1]==2000 && xbins[AAA2]==2300)) Alpha2=alpha;
    if(SignalMass==2500 && (xbins[AAA1]==2500 && xbins[AAA2]==2950)) Alpha2=alpha;
    if(SignalMass== 800 && (xbins[AAA1]== 675 && xbins[AAA2]== 800)) AlphaERR1=alpha_err;
    if(SignalMass== 900 && (xbins[AAA1]== 750 && xbins[AAA2]== 900)) AlphaERR1=alpha_err;
    if(SignalMass==1000 && (xbins[AAA1]== 850 && xbins[AAA2]==1000)) AlphaERR1=alpha_err;
    if(SignalMass==1200 && (xbins[AAA1]==1000 && xbins[AAA2]==1200)) AlphaERR1=alpha_err;
    if(SignalMass==1500 && (xbins[AAA1]==1250 && xbins[AAA2]==1500)) AlphaERR1=alpha_err;
    if(SignalMass==2000 && (xbins[AAA1]==1700 && xbins[AAA2]==2000)) AlphaERR1=alpha_err;
    if(SignalMass==2500 && (xbins[AAA1]==2050 && xbins[AAA2]==2500)) AlphaERR1=alpha_err;
    if(SignalMass== 800 && (xbins[AAA1]== 800 && xbins[AAA2]== 925)) AlphaERR2=alpha_err;
    if(SignalMass== 900 && (xbins[AAA1]== 900 && xbins[AAA2]==1050)) AlphaERR2=alpha_err;
    if(SignalMass==1000 && (xbins[AAA1]==1000 && xbins[AAA2]==1150)) AlphaERR2=alpha_err;
    if(SignalMass==1200 && (xbins[AAA1]==1200 && xbins[AAA2]==1400)) AlphaERR2=alpha_err;
    if(SignalMass==1500 && (xbins[AAA1]==1500 && xbins[AAA2]==1750)) AlphaERR2=alpha_err;
    if(SignalMass==2000 && (xbins[AAA1]==2000 && xbins[AAA2]==2300)) AlphaERR2=alpha_err;
    if(SignalMass==2500 && (xbins[AAA1]==2500 && xbins[AAA2]==2950)) AlphaERR2=alpha_err;
    if(SignalMass== 800 && (xbins[AAA1]== 675 && xbins[AAA2]== 800)) Nsideband1=N_sb;
    if(SignalMass== 900 && (xbins[AAA1]== 750 && xbins[AAA2]== 900)) Nsideband1=N_sb;
    if(SignalMass==1000 && (xbins[AAA1]== 850 && xbins[AAA2]==1000)) Nsideband1=N_sb;
    if(SignalMass==1200 && (xbins[AAA1]==1000 && xbins[AAA2]==1200)) Nsideband1=N_sb;
    if(SignalMass==1500 && (xbins[AAA1]==1250 && xbins[AAA2]==1500)) Nsideband1=N_sb;
    if(SignalMass==2000 && (xbins[AAA1]==1700 && xbins[AAA2]==2000)) Nsideband1=N_sb;
    if(SignalMass==2500 && (xbins[AAA1]==2050 && xbins[AAA2]==2500)) Nsideband1=N_sb;
    if(SignalMass== 800 && (xbins[AAA1]== 800 && xbins[AAA2]== 925)) Nsideband2=N_sb;
    if(SignalMass== 900 && (xbins[AAA1]== 900 && xbins[AAA2]==1050)) Nsideband2=N_sb;
    if(SignalMass==1000 && (xbins[AAA1]==1000 && xbins[AAA2]==1150)) Nsideband2=N_sb;
    if(SignalMass==1200 && (xbins[AAA1]==1200 && xbins[AAA2]==1400)) Nsideband2=N_sb;
    if(SignalMass==1500 && (xbins[AAA1]==1500 && xbins[AAA2]==1750)) Nsideband2=N_sb;
    if(SignalMass==2000 && (xbins[AAA1]==2000 && xbins[AAA2]==2300)) Nsideband2=N_sb;
    if(SignalMass==2500 && (xbins[AAA1]==2500 && xbins[AAA2]==2950)) Nsideband2=N_sb;
...
void SaveDatacard(char *channel, float DATYield, float BkgYield, float BkgYieldErr, float NSideband, float Alpha1, float Alpha2, float AlphaErr1, float AlphaErr2,float NORMforALPHA, float SigYield, int SignalMass, float lep1PtCut, float tauPtCut, int bTagCut, float METCut, float deltaRCut, float MassSvfitCut, float MassVisCut){
  ...
  if(channel=="MuoTau" && SignalMass==1200) TauIDStandard = 1 + 0.089;
  if(channel=="EleTau" && SignalMass==1200) TauIDStandard = 1 + 0.085;
  ...
  if(channel=="MuoTau" && SignalMass==1000) TauCleaning = 1 + 0.004;
  if(channel=="EleTau" && SignalMass==1000) TauCleaning = 1 + 0.005;
  if(channel=="MuoTau" && SignalMass==1200) TauCleaning = 1 + 0.004;
  if(channel=="EleTau" && SignalMass==1200) TauCleaning = 1 + 0.005;
  if(channel=="MuoTau" && SignalMass==1500) TauCleaning = 1 + 0.035;
  if(channel=="EleTau" && SignalMass==1500) TauCleaning = 1 + 0.031;
  if(channel=="MuoTau" && SignalMass==2000) TauCleaning = 1 + 0.060;
  if(channel=="EleTau" && SignalMass==2000) TauCleaning = 1 + 0.068;
  ...
  if(channel=="MuoTau" && SignalMass==1000) MuonCleaning = 1 + 0.007;
  if(channel=="MuoTau" && SignalMass==1200) MuonCleaning = 1 + 0.007;
  if(channel=="MuoTau" && SignalMass==1500) MuonCleaning = 1 + 0.017;
  if(channel=="MuoTau" && SignalMass==2000) MuonCleaning = 1 + 0.016;
  ...
  if(channel=="MuoTau" && SignalMass==1000) ModifiedPFIso = 1 + 0.012;
  if(channel=="EleTau" && SignalMass==1000) ModifiedPFIso = 1 + 0.035;
  if(channel=="MuoTau" && SignalMass==1200) ModifiedPFIso = 1 + 0.012;
  if(channel=="EleTau" && SignalMass==1200) ModifiedPFIso = 1 + 0.035;
  if(channel=="MuoTau" && SignalMass==1500) ModifiedPFIso = 1 + 0.061;
  if(channel=="EleTau" && SignalMass==1500) ModifiedPFIso = 1 + 0.035;
  if(channel=="MuoTau" && SignalMass==2000) ModifiedPFIso = 1 + 0.095;
  if(channel=="EleTau" && SignalMass==2000) ModifiedPFIso = 1 + 0.098;
  ...
  if(channel=="EleMuo" && SignalMass==1000) PUReweighting = 1 + 0.006;
  if(channel=="MuoMuo" && SignalMass==1000) PUReweighting = 1 + 0.013;
  if(channel=="EleEle" && SignalMass==1000) PUReweighting = 1 + 0.004;
  if(channel=="MuoTau" && SignalMass==1000) PUReweighting = 1 + 0.011;
  if(channel=="EleTau" && SignalMass==1000) PUReweighting = 1 + 0.012;
  if(channel=="EleMuo" && SignalMass==1200) PUReweighting = 1 + 0.006;
  if(channel=="MuoMuo" && SignalMass==1200) PUReweighting = 1 + 0.013;
  if(channel=="EleEle" && SignalMass==1200) PUReweighting = 1 + 0.004;
  if(channel=="MuoTau" && SignalMass==1200) PUReweighting = 1 + 0.011;
  if(channel=="EleTau" && SignalMass==1200) PUReweighting = 1 + 0.012;
  if(channel=="EleMuo" && SignalMass==1500) PUReweighting = 1 + 0.018;
  if(channel=="MuoMuo" && SignalMass==1500) PUReweighting = 1 + 0.015;
  if(channel=="EleEle" && SignalMass==1500) PUReweighting = 1 + 0.011;
  if(channel=="MuoTau" && SignalMass==1500) PUReweighting = 1 + 0.014;
  if(channel=="EleTau" && SignalMass==1500) PUReweighting = 1 + 0.007;
  if(channel=="EleMuo" && SignalMass==2000) PUReweighting = 1 + 0.002;
  if(channel=="MuoMuo" && SignalMass==2000) PUReweighting = 1 + 0.010;
  if(channel=="EleEle" && SignalMass==2000) PUReweighting = 1 + 0.004;
  if(channel=="MuoTau" && SignalMass==2000) PUReweighting = 1 + 0.004;
  if(channel=="EleTau" && SignalMass==2000) PUReweighting = 1 + 0.012;
  ...
  if(channel=="EleMuo" && SignalMass==1000) BTagSyst = 1 + 0.018;
  if(channel=="MuoMuo" && SignalMass==1000) BTagSyst = 1 + 0.024;
  if(channel=="EleEle" && SignalMass==1000) BTagSyst = 1 + 0.040;
  if(channel=="MuoTau" && SignalMass==1000) BTagSyst = 1 + 0.023;
  if(channel=="EleTau" && SignalMass==1000) BTagSyst = 1 + 0.024;
  if(channel=="EleMuo" && SignalMass==1200) BTagSyst = 1 + 0.018;
  if(channel=="MuoMuo" && SignalMass==1200) BTagSyst = 1 + 0.024;
  if(channel=="EleEle" && SignalMass==1200) BTagSyst = 1 + 0.040;
  if(channel=="MuoTau" && SignalMass==1200) BTagSyst = 1 + 0.023;
  if(channel=="EleTau" && SignalMass==1200) BTagSyst = 1 + 0.024;
  if(channel=="EleMuo" && SignalMass==1500) BTagSyst = 1 + 0.027;
  if(channel=="MuoMuo" && SignalMass==1500) BTagSyst = 1 + 0.023;
  if(channel=="EleEle" && SignalMass==1500) BTagSyst = 1 + 0.056;
  if(channel=="MuoTau" && SignalMass==1500) BTagSyst = 1 + 0.026;
  if(channel=="EleTau" && SignalMass==1500) BTagSyst = 1 + 0.026;
  if(channel=="EleMuo" && SignalMass==2000) BTagSyst = 1 + 0.031;
  if(channel=="MuoMuo" && SignalMass==2000) BTagSyst = 1 + 0.023;
  if(channel=="EleEle" && SignalMass==2000) BTagSyst = 1 + 0.030;
  if(channel=="MuoTau" && SignalMass==2000) BTagSyst = 1 + 0.025;
  if(channel=="EleTau" && SignalMass==2000) BTagSyst = 1 + 0.025;
  ...
  if(channel=="EleMuo" && SignalMass==1000) EleID = 1 + 0.011;
  if(channel=="EleEle" && SignalMass==1000) EleID = 1 + 0.026;
  if(channel=="EleTau" && SignalMass==1000) EleID = 1 + 0.013;
  if(channel=="EleMuo" && SignalMass==1200) EleID = 1 + 0.011;
  if(channel=="EleEle" && SignalMass==1200) EleID = 1 + 0.026;
  if(channel=="EleTau" && SignalMass==1200) EleID = 1 + 0.013;
  if(channel=="EleMuo" && SignalMass==1500) EleID = 1 + 0.015;
  if(channel=="EleEle" && SignalMass==1500) EleID = 1 + 0.025;
  if(channel=="EleTau" && SignalMass==1500) EleID = 1 + 0.013;
  if(channel=="EleMuo" && SignalMass==2000) EleID = 1 + 0.016;
  if(channel=="EleEle" && SignalMass==2000) EleID = 1 + 0.030;
  if(channel=="EleTau" && SignalMass==2000) EleID = 1 + 0.016;
  ...
  if(channel=="EleMuo" && SignalMass==1000) EleScale = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1000) EleScale = 1 + 0.000;
  if(channel=="EleTau" && SignalMass==1000) EleScale = 1 + 0.004;
  if(channel=="EleMuo" && SignalMass==1200) EleScale = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1200) EleScale = 1 + 0.000;
  if(channel=="EleTau" && SignalMass==1200) EleScale = 1 + 0.004;
  if(channel=="EleMuo" && SignalMass==1500) EleScale = 1 + 0.004;
  if(channel=="EleEle" && SignalMass==1500) EleScale = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==1500) EleScale = 1 + 0.001;
  if(channel=="EleMuo" && SignalMass==2000) EleScale = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==2000) EleScale = 1 + 0.009;
  if(channel=="EleTau" && SignalMass==2000) EleScale = 1 + 0.001;
  ...
  if(channel=="EleMuo" && SignalMass==1000) EleResol = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1000) EleResol = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==1000) EleResol = 1 + 0.005;
  if(channel=="EleMuo" && SignalMass==1200) EleResol = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1200) EleResol = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==1200) EleResol = 1 + 0.005;
  if(channel=="EleMuo" && SignalMass==1500) EleResol = 1 + 0.006;
  if(channel=="EleEle" && SignalMass==1500) EleResol = 1 + 0.024;
  if(channel=="EleTau" && SignalMass==1500) EleResol = 1 + 0.002;
  if(channel=="EleMuo" && SignalMass==2000) EleResol = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==2000) EleResol = 1 + 0.003;
  if(channel=="EleTau" && SignalMass==2000) EleResol = 1 + 0.000;
  ...
  if(channel=="EleMuo" && SignalMass==1000) MuoID = 1 + 0.010;
  if(channel=="MuoMuo" && SignalMass==1000) MuoID = 1 + 0.057;
  if(channel=="MuoTau" && SignalMass==1000) MuoID = 1 + 0.009;
  if(channel=="EleMuo" && SignalMass==1200) MuoID = 1 + 0.010;
  if(channel=="MuoMuo" && SignalMass==1200) MuoID = 1 + 0.057;
  if(channel=="MuoTau" && SignalMass==1200) MuoID = 1 + 0.009;
  if(channel=="EleMuo" && SignalMass==1500) MuoID = 1 + 0.009;
  if(channel=="MuoMuo" && SignalMass==1500) MuoID = 1 + 0.057;
  if(channel=="MuoTau" && SignalMass==1500) MuoID = 1 + 0.008;
  if(channel=="EleMuo" && SignalMass==2000) MuoID = 1 + 0.009;
  if(channel=="MuoMuo" && SignalMass==2000) MuoID = 1 + 0.057;
  if(channel=="MuoTau" && SignalMass==2000) MuoID = 1 + 0.008;
  ...
  if(channel=="EleMuo" && SignalMass==1000) MuoScale = 1 + 0.007;
  if(channel=="MuoMuo" && SignalMass==1000) MuoScale = 1 + 0.019;
  if(channel=="MuoTau" && SignalMass==1000) MuoScale = 1 + 0.003;
  if(channel=="EleMuo" && SignalMass==1200) MuoScale = 1 + 0.007;
  if(channel=="MuoMuo" && SignalMass==1200) MuoScale = 1 + 0.019;
  if(channel=="MuoTau" && SignalMass==1200) MuoScale = 1 + 0.003;
  if(channel=="EleMuo" && SignalMass==1500) MuoScale = 1 + 0.011;
  if(channel=="MuoMuo" && SignalMass==1500) MuoScale = 1 + 0.002;
  if(channel=="MuoTau" && SignalMass==1500) MuoScale = 1 + 0.008;
  if(channel=="EleMuo" && SignalMass==2000) MuoScale = 1 + 0.001;
  if(channel=="MuoMuo" && SignalMass==2000) MuoScale = 1 + 0.000;
  if(channel=="MuoTau" && SignalMass==2000) MuoScale = 1 + 0.007;
  ...
  if(channel=="EleMuo" && SignalMass==1000) MuoResol = 1 + 0.000;
  if(channel=="MuoMuo" && SignalMass==1000) MuoResol = 1 + 0.019;
  if(channel=="MuoTau" && SignalMass==1000) MuoResol = 1 + 0.001;
  if(channel=="EleMuo" && SignalMass==1200) MuoResol = 1 + 0.000;
  if(channel=="MuoMuo" && SignalMass==1200) MuoResol = 1 + 0.019;
  if(channel=="MuoTau" && SignalMass==1200) MuoResol = 1 + 0.001;
  if(channel=="EleMuo" && SignalMass==1500) MuoResol = 1 + 0.005;
  if(channel=="MuoMuo" && SignalMass==1500) MuoResol = 1 + 0.000;
  if(channel=="MuoTau" && SignalMass==1500) MuoResol = 1 + 0.004;
  if(channel=="EleMuo" && SignalMass==2000) MuoResol = 1 + 0.001;
  if(channel=="MuoMuo" && SignalMass==2000) MuoResol = 1 + 0.000;
  if(channel=="MuoTau" && SignalMass==2000) MuoResol = 1 + 0.002;
  ...
  if(channel=="MuoTau" && SignalMass==1000) TauScale = 1 + 0.003;
  if(channel=="EleTau" && SignalMass==1000) TauScale = 1 + 0.024;
  if(channel=="MuoTau" && SignalMass==1200) TauScale = 1 + 0.003;
  if(channel=="EleTau" && SignalMass==1200) TauScale = 1 + 0.024;
  if(channel=="MuoTau" && SignalMass==1500) TauScale = 1 + 0.010;
  if(channel=="EleTau" && SignalMass==1500) TauScale = 1 + 0.006;
  if(channel=="MuoTau" && SignalMass==2000) TauScale = 1 + 0.004;
  if(channel=="EleTau" && SignalMass==2000) TauScale = 1 + 0.009;
  ...
  if(channel=="EleMuo" && SignalMass==1000) JES = 1 + 0.011;
  if(channel=="MuoMuo" && SignalMass==1000) JES = 1 + 0.026;
  if(channel=="EleEle" && SignalMass==1000) JES = 1 + 0.043;
  if(channel=="MuoTau" && SignalMass==1000) JES = 1 + 0.009;
  if(channel=="EleTau" && SignalMass==1000) JES = 1 + 0.014;
  if(channel=="EleMuo" && SignalMass==1200) JES = 1 + 0.011;
  if(channel=="MuoMuo" && SignalMass==1200) JES = 1 + 0.026;
  if(channel=="EleEle" && SignalMass==1200) JES = 1 + 0.043;
  if(channel=="MuoTau" && SignalMass==1200) JES = 1 + 0.009;
  if(channel=="EleTau" && SignalMass==1200) JES = 1 + 0.014;
  if(channel=="EleMuo" && SignalMass==1500) JES = 1 + 0.005;
  if(channel=="MuoMuo" && SignalMass==1500) JES = 1 + 0.012;
  if(channel=="EleEle" && SignalMass==1500) JES = 1 + 0.008;
  if(channel=="MuoTau" && SignalMass==1500) JES = 1 + 0.007;
  if(channel=="EleTau" && SignalMass==1500) JES = 1 + 0.003;
  if(channel=="EleMuo" && SignalMass==2000) JES = 1 + 0.009;
  if(channel=="MuoMuo" && SignalMass==2000) JES = 1 + 0.010;
  if(channel=="EleEle" && SignalMass==2000) JES = 1 + 0.020;
  if(channel=="MuoTau" && SignalMass==2000) JES = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==2000) JES = 1 + 0.005;
  ...
  if(channel=="EleMuo" && SignalMass==1000) JER = 1 + 0.007;
  if(channel=="MuoMuo" && SignalMass==1000) JER = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1000) JER = 1 + 0.000;
  if(channel=="MuoTau" && SignalMass==1000) JER = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==1000) JER = 1 + 0.003;
  if(channel=="EleMuo" && SignalMass==1200) JER = 1 + 0.007;
  if(channel=="MuoMuo" && SignalMass==1200) JER = 1 + 0.000;
  if(channel=="EleEle" && SignalMass==1200) JER = 1 + 0.000;
  if(channel=="MuoTau" && SignalMass==1200) JER = 1 + 0.001;
  if(channel=="EleTau" && SignalMass==1200) JER = 1 + 0.003;
  if(channel=="EleMuo" && SignalMass==1500) JER = 1 + 0.007;
  if(channel=="MuoMuo" && SignalMass==1500) JER = 1 + 0.016;
  if(channel=="EleEle" && SignalMass==1500) JER = 1 + 0.022;
  if(channel=="MuoTau" && SignalMass==1500) JER = 1 + 0.018;
  if(channel=="EleTau" && SignalMass==1500) JER = 1 + 0.012;
  if(channel=="EleMuo" && SignalMass==2000) JER = 1 + 0.000;
  if(channel=="MuoMuo" && SignalMass==2000) JER = 1 + 0.005;
  if(channel=="EleEle" && SignalMass==2000) JER = 1 + 0.017;
  if(channel=="MuoTau" && SignalMass==2000) JER = 1 + 0.017;
  if(channel=="EleTau" && SignalMass==2000) JER = 1 + 0.015;
  ...
  if(NSideband!=0){
    ...
    myfile<<"Alpha"<<channel<<"         lnN       -                "<<1+sqrt(AlphaErr1*AlphaErr1+AlphaErr2*AlphaErr2)/((Alpha1+Alpha2)*NORMforALPHA)<<endl;
    myfile<<"Normalization"<<channel<<" lnN       -                "<<SYSTNormalization<<endl;
  }
